...
'''
    Runs test cases for the Rectangle
'''
...
class test_rectangle(unittest.TestCase):
    ...
    def test_update_width(self):
        '''
            Testing the update width method
        '''
        self.r.update(54, 30)
    ...
    def test_update_height(self):
        '''
            Testing the update height method
        '''
    ...
    def test_dict_to_instance(self):
        '''
            Test the instance of when is created from a dict
        '''
        r1 = Rectangle(5, 8, 3)
    ...
    def test_load_from_file_not_the_same(self):
        '''
            Checking the object was created from the
